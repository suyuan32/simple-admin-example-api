...
require (
	...
	github.com/suyuan32/simple-admin-example-rpc v0.0.0-20230111132720-f5887d47de28
...
replace github.com/zeromicro/go-zero v1.4.3 => github.com/suyuan32/simple-admin-tools v0.1.4
